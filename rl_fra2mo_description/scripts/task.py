...
class TaskNode(Node):
    ...
    def publish_static_tf(self, position, orientation):
        """Pubblica una trasformazione statica per il marker."""
        transform = TransformStamped()
        transform.header.stamp = self.get_clock().now().to_msg()
        transform.header.frame_id = 'camera_link'
        transform.child_frame_id = 'aruco_marker_frame'
        ...
        self.get_logger().info("Published static TF for ArUco marker.")
